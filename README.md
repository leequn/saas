...
## Preparing
Folder **sex_biased_as** contains splice sequence similarity scripts and raw splicing and sequences files <br>
...
You can sent us **kidney_saas.csv** on the [submission webpage](https://saas.liaolab.net/submission.php) or [email](mailto:liaomingzhi83@163.com).
```
out/
├── as
│   ├── A3SS.MATS.txt
